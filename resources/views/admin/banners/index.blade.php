                            ...
                            @foreach($banners as $banner)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($banner->image)
                                            <img src="{{ asset('storage/' . $banner->image) }}" alt="{{ $banner->title }}" class="w-16 h-16 object-cover rounded cursor-pointer" onclick="openModal('{{ asset('storage/' . $banner->image) }}')">
                                        @else
                                            <span class="text-gray-500">{{ __('No Image') }}</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $banner->link }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ ucfirst($banner->section) }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $banner->order_column }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
