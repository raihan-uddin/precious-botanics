                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input id="tax_rate" name="tax_rate" class="block mt-1 w-full" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-select id="is_taxable" name="is_taxable" class="block mt-1 w-full" required>
                                        <option
                                            value="1" {{ old('is_taxable', $product->is_taxable) == 1 ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option
                                            value="0" {{ old('is_taxable', $product->is_taxable) == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </x-select>
                                    @error('is_taxable')
                            ...
                            <div class="grid grid-cols-5 gap-4 mt-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input id="weight" name="weight" class="block mt-1 w-full" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input id="length" name="length" class="block mt-1 w-full" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input id="width" name="width" class="block mt-1 w-full" type="text"
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-input id="height" name="height" class="block mt-1 w-full" type="text"
                            ...
                            <div class="grid grid-cols-4 gap-4 mt-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-select id="is_visible" name="is_visible" class="block mt-1 w-full" required>
                                        <option
                                            value="1" {{ old('is_visible', $product->is_visible) == 1 ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option
                                            value="0" {{ old('is_visible', $product->is_visible) == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </x-select>
                                    @error('is_visible')
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-select id="is_digital" name="is_digital" class="block mt-1 w-full" required>
                                        <option
                                            value="1" {{ old('is_digital', $product->is_digital) == 1 ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option
                                            value="0" {{ old('is_digital', $product->is_digital) == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </x-select>
                                    @error('is_digital')
                            ...
                            <div class="mb-4">
                                ...
                                <div id="variants" class="block mt-1 w-full">
                                    ...
                                    <div id="variantsPreview" class="mt-4 grid grid-cols-1 gap-4 ">
                                        <!-- Dynamically added variants will be displayed here -->
                                        @foreach($product->variants as $variant)
                                            <div
                                                class="bg-gray-100 border border-gray-300 rounded-md p-4 flex justify-between items-center">
                                                <div class="variant-group" data-key="{{ $variant->id }}">
                                                    <strong>Size:</strong> {{ $variant->size }},
                                                    <strong>Color:</strong> {{ $variant->color }},
                                                    <strong>Price:</strong> ${{ $variant->price }},
                                                    <strong>SKU:</strong> {{ $variant->sku }},
                                                    <strong>Stock:</strong> {{ $variant->stock }}
                                                    <input type="hidden" name="variants[{{ $variant->id }}][size]"
                                                           value="{{ $variant->size }}">
                                                    <input type="hidden" name="variants[{{ $variant->id }}][color]"
                                                           value="{{ $variant->color }}">
                                                    <input type="hidden" name="variants[{{ $variant->id }}][price]"
                                                           value="{{ $variant->price }}">
                                                    <input type="hidden" name="variants[{{ $variant->id }}][sku]"
                                                           value="{{ $variant->sku }}">
                                                    <input type="hidden" name="variants[{{ $variant->id }}][stock]"
                                                           value="{{ $variant->stock }}">
                                                </div>
                                                <button type="button" class="text-red-600 removeVariant">&times;
                                                </button>
                                            </div>
                                        @endforeach
